  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-5 lg:py-8">
        <div className="top">
          <div className="bg-pink-50 py-5 border border-pink-100 rounded-xl">
                  ...
                  <div key={index} className="">
                    {order.cartItems.map((item, index) => {
                      ...
                      return (
                        <div
                          key={index}
                          className="mx-5 flex flex-col overflow-hidden rounded-xl border border-pink-100  md:flex-row"
                        >
