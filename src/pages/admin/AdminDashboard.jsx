    ...
    <div>
      ...
      <div className="px-5">
        ...
        <div className="mid mb-5">
          {/* main  */}
          <div className="bg-pink-50 rounded-xl py-5 border border-pink-100">
            {/* image  */}
          ...
          <TabList className="flex flex-wrap -m-4 text-center justify-center">
            ...
            <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
              <div className="border bg-pink-50 hover:bg-pink-100 border-pink-100 px-4 py-3 rounded-xl">
                <div className="text-pink-500 h-12 w-12 mb-3 inline-block">
                  <svg
                ...
                <h2 className="title-font font-mediumtext-3xl text-pink-400 fonts1">
